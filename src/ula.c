...
int valor = 0;  // variavel out.value é int8_t (8 bits), por isso criamos uma variavel nova
    ...
    switch (ulaControl){    // ulaControl ja indica qual operação deve ser feita, vinda de control.c
        ...
        case 4: // AND
            ...
            out.zeroUla = (out.value == 0); // Retorna 1 se o valor for 0. usado no clock.c para decidir se um BEQ deve ser executado
        break;
        case 5: // OR
            out.value = input1 | input2;
